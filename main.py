...
class MainMainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        #connecting the buttons yeah this part is a mess ik i am bad at naming things 
    ...
    def match(self):
        ...
        if score < 2:
            ...
            self.end_dialog.ui2.label_2.setText(_translate("Dialog", "We're not a match. My day is ruined, and my disappointment is immeasurable. Good thing my girlfriend is an AI anyway."))
        else:
